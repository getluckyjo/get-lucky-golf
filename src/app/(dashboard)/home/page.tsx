      ...
      <div className="screen-home">
        ...
        <div className="home-hero-card">
          ...
          <button
            ...
            style={{ width: 'auto', padding: '14px 28px', fontSize: 15 }}
          >
            Play Now →
          </button>
        </div>
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: '#8a6a10', marginBottom: 2 }}>
                  Claim Under Review
                </div>
                <div style={{ fontSize: 11, color: '#a07820' }}>
                  {activeClaim.courses?.name ?? 'Your hole-in-one'} · Tap to check status
                </div>
              </div>
              <span style={{ fontSize: 14, color: '#a07820' }}>→</span>
            </div>
          )
        })()}
        ...
        <div style={{ display: 'flex', gap: 12, padding: '0 24px', marginBottom: 24 }}>
          {authLoading ? (
            [0, 1, 2].map(i => (
              <div key={i} style={{ flex: 1, background: 'white', borderRadius: 14, padding: '14px 12px', border: '1px solid #e8e4dc', textAlign: 'center' }}>
            ...
            [
              ...
              >
                <div style={{ fontFamily: 'Playfair Display, serif', fontSize: 22, fontWeight: 900, color: 'var(--green-deep)' }}>
                  {stat.value}
                </div>
                <div style={{ fontSize: 11, color: 'var(--gray-light)', marginTop: 2 }}>{stat.label}</div>
              </div>
            ))
          )}
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px', marginBottom: 12 }}>
          ...
          {bets.length > 0 && (
            <button
              ...
              style={{ fontSize: 12, fontWeight: 600, color: 'var(--green-mid)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
            >
              See all →
            </button>
          )}
        </div>
        <div style={{ paddingLeft: 24, paddingRight: 24, paddingBottom: 88, display: 'flex', flexDirection: 'column', gap: 10 }}>
          {betsLoading ? (
            <>
              {[0, 1, 2].map(i => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: 14, background: 'white', borderRadius: 14, border: '1px solid #e8e4dc' }}>
            ...
            <div style={{
              padding: '28px 20px', textAlign: 'center', background: 'white',
              borderRadius: 14, border: '1px solid #e8e4dc',
            }}>
              <div style={{ fontSize: 32, marginBottom: 8 }}>🏌️</div>
              <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--green-deep)', marginBottom: 4 }}>
                No attempts yet
              </div>
            ...
            bets.map(bet => {
              ...
              return (
                ...
                >
                  <div style={{
                    width: 40, height: 40, background: 'linear-gradient(135deg, #b8d4b0, #7ab068)',
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--black)', marginBottom: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
        ...
        >
          ...
          >
            ...
            {editMode ? (
              /* Edit mode */
              <>
                <div style={{ fontSize: 17, fontWeight: 700, color: 'var(--green-deep)', marginBottom: 20 }}>
                  Edit Profile
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <div>
                    <label style={{ fontSize: 12, fontWeight: 600, color: 'var(--gray-light)', display: 'block', marginBottom: 6 }}>
                      Full Name
                    </label>
                    <input
                      value={editName}
                      ...
                      style={{
                        ...
                        border: '1.5px solid #e0dbd0', fontSize: 15, outline: 'none',
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
                  <button
                    ...
                    style={{
                      flex: 1, padding: '13px', background: '#f5f0e8',
              ...
              <>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 17, fontWeight: 700, color: 'var(--green-deep)' }}>
                      {displayName ?? 'Golfer'}
                    </div>
                    ...
                    {profile?.handicap != null && (
                      <div style={{ fontSize: 12, color: 'var(--green-mid)', marginTop: 2, fontWeight: 600 }}>
                ...
                {profile?.payment_method && (
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: 'var(--gray-light)' }}>Payment method</div>
                    </div>
                  </div>
                )}
